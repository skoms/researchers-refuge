...
export const getHandlers = [
  ...
  rest.get(getUrl('/admin/articles'), (req, res, ctx) => {
    ...
    return res(
      ctx.status(200),
      ctx.json(
        getListOfTypeData('articles', getMockArticles, { limit, page })
      )
    )
  }),
  rest.get(getUrl('/admin/articles/search'), (req, res, ctx) => {
    ...
    return res(
      ctx.status(200),
      ctx.json(
        getListOfTypeData('articles', getMockArticles, { amount: 25, limit, page })
      )
    )
  }),
  ...
  rest.get(getUrl('/admin/categories'), (req, res, ctx) => {
    ...
    return res(
      ctx.status(200),
      ctx.json(
        getListOfTypeData('categories', getMockCategories, { amount: 5, limit, page })
      )
    )
  }),
  rest.get(getUrl('/admin/categories/search'), (req, res, ctx) => {
    ...
    return res(
      ctx.status(200),
      ctx.json(
        getListOfTypeData('categories', getMockCategories, { amount: 2, limit, page })
      )
    )
  }),
  rest.get(getUrl('/admin/reports'), (req, res, ctx) => {
    ...
    return res(
      ctx.status(200),
      ctx.json(
        getListOfTypeData('reports', getMockReports, { limit, page })
      )
    )
  }),
  rest.get(getUrl('/admin/reports/search'), (req, res, ctx) => {
    ...
    return res(
      ctx.status(200),
      ctx.json(
        getListOfTypeData('reports', getMockReports, { amount: 25, limit, page })
      )
    )
  }),
  ...
  rest.get(getUrl('/articles/tag'), (req, res, ctx) => {
    return res(
      ctx.status(200),
      ctx.json( getMockArticles({ amount: 5 }) )
    )
  }),
  ...
  rest.get(getUrl('/reports'), (req, res, ctx) => {
    return res(
      ctx.status(403),
      ctx.json({
        errorMessage: 'Reports can only be accessed with the correct authorization and through its designated admin route'
      })
    )
  }),
  ...
  rest.get(getUrl('/topics'), (req, res, ctx) => {
    return res(
      ctx.status(200),
      ctx.json( getMockTopics({ amount: 40 }) )
    )
  }),
  rest.get(getUrl('/topics/tag'), (req, res, ctx) => {
    return res(
      ctx.status(200),
      ctx.json( getMockTopics({ amount: 5 }) )
    )
  }),
