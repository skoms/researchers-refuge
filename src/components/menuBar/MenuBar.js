  ...
  return (
    <div className={styles.container} data-testid="menubar-component">
      <div>
        ...
        <button className={styles.button} onClick={select} value="new">
          New
        </button>
        <button className={styles.button} onClick={select} value="top">
          Top
        </button>
        <button className={styles.button} onClick={select} value="following">
          Following
        </button>
      </div>
