...
describe('InfoModule', () => {
  ...
  describe('general', () => {
    ...
    beforeEach(() => {
      act(() => { renderComponent(InfoModule, { expectedProps }) })
    });
    ...
    it('should render the image given through props', () => {
      ...
      ).toBe('https://randomuser.me/api/portraits/men/75.jpg');
    });
    
    it('should not render with admin icon', () => {
      expect(
        screen.queryByAltText(/admin icon/i)
      ).toBeNull();
    });
  ...
  describe('as admin', () => {
    ...
    it('should render the admin icon behing name', () => {
      expect(
        screen.getByAltText(/admin icon/i)
      ).toBeInTheDocument();
    });
  })
  ...
  describe('With missing props', () => {
    ...
    it('should render the image given through props', () => {
      expect(
        screen.getByRole('img').src
      ).toBe('https://img.icons8.com/ios-glyphs/75/FFFFFF/user--v1.png');
    });
    ...
    it('should render cells with default data', () => {
      expect(
        screen.getAllByRole('cell', { name: /^()|(0)$/i })
      ).toHaveLength(5);
    });
  });
