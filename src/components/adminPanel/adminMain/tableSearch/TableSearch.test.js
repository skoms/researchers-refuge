...
describe('TableSearch', () => {
  ...
  it('should not render clear button when field is empty', () => {
    expect(screen.queryByAltText(/clear search button/i)).toBeNull()
  })

  it('should render the clear button when field is not empty', () => {
    userEvent.type(screen.getByRole('textbox'), 'test string')
    expect(screen.queryByAltText(/clear search button/i)).not.toBeNull()
  })
