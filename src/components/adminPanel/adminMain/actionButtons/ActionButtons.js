      ...
      <div className={styles.container} data-testid="action-buttons-component">
        <button className={styles.button} onClick={viewData}>
          <img
            ...
            src={getIconUrl('eye', null, {
              size: 16,
              colors: { light: getButtonColor() },
            })}
            alt="view button"
          />
        ...
        {type === 'users' || type === 'articles' ? (
          ...
          >
            ...
            <div
              ...
              data-testid="more-menu-dropdown"
            >
              {(type === 'users' || type === 'articles') && (
                <button
          ...
          <>
            <button
              ...
              className={`${styles.button} ${
                statusFilter === 'open' ? 'disabled' : ''
              }`}
            >
              <img
                className={styles.buttonIcon}
                src={getIconUrl('parcel', null, {
                  size: 16,
                  colors: { light: getButtonColor() },
                })}
                alt="mark as open"
            ...
            <button
              ...
              className={`${styles.button} ${
                statusFilter === 'resolved' ? 'disabled' : ''
              }`}
            >
              <img
                className={styles.buttonIcon}
                src={getIconUrl('checkmark-box', null, {
                  size: 16,
                  colors: { light: getButtonColor() },
                })}
            ...
            <button
              ...
              className={`${styles.button} ${
                statusFilter === 'rejected' ? 'disabled' : ''
              }`}
            >
              <img
                className={styles.buttonIcon}
                src={getIconUrl('x-box', null, {
                  size: 16,
                  colors: { light: getButtonColor() },
                })}
