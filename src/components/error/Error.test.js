...
describe('Error', () => {
  ...
  describe('Forbidden', () => {
    beforeEach(() => {
      act(() => {
        renderComponent(Forbidden, { needsMemoryRouter })
      })
    })

    it('should render without any errors', () => {
      expect(screen.getByAltText(/stop-sign/i)).toBeInTheDocument()
    })
    ...
    it('should call mockHistoryPush when clicking the button', () => {
      ...
      expect(mockHistoryPush).toHaveBeenLastCalledWith({ pathname: '/' })
    })
  })
  ...
  describe('NotFound', () => {
    beforeEach(() => {
      act(() => {
        renderComponent(NotFound, { needsMemoryRouter })
      })
    })
  ...
  describe('UnhandledError', () => {
    describe('without props', () => {
      ...
      beforeEach(() => {
        act(() => {
          store = renderComponent(UnhandledError, {
            needsMemoryRouter,
            needsStore: true,
          }).store
        })
      ...
      it('should render with a span for issuing reports', () => {
        expect(screen.getByText(/issue a bug report/i)).toBeInTheDocument()
      })
    ...
    describe('with props', () => {
      ...
      it('should render with an errors message', () => {
        expect(screen.getByText(expectedProps.errorMessage)).toBeInTheDocument()
      })

      it('should render with an error stack', () => {
        expect(screen.getByText(expectedProps.errorStack)).toBeInTheDocument()
      })
