...
const mockContainerRef = jest
  .fn()
  .mockReturnValue({ current: { classList: '' } })
...
describe('Confirmation Popup', () => {
  ...
  beforeEach(() => {
    act(() => {
      renderComponent(ConfirmationPopup, { expectedProps })
    })
  })
  ...
  it('should render without any errors', () => {
    expect(screen.getByTestId('blurred-background')).toBeInTheDocument()
  })
