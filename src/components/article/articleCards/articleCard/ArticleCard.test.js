...
describe('ArticleCard', () => {
  describe('regardless of login status', () => {
    ...
    it('should render without any errors', () => {
      expect(screen.getByTestId('article-card-component')).toBeInTheDocument()
    })
    ...
    it('should render buttons with default unchecked color #CECECE', () => {
      expect(screen.getByAltText(/accredit button/i).src).toBe(
        'https://img.icons8.com/ios-filled/20/CECECE/checkmark--v1.png',
      )
    })
  ...
  describe('When logged in', () => {
    ...
    it('should render accredited button marked', () => {
      ...
      expect(screen.getByAltText(/accredit button/i).src).toBe(
        'https://img.icons8.com/ios-filled/20/00A300/checkmark--v1.png',
      )
    })
    ...
    it('should render discredited button marked', () => {
      ...
      expect(screen.getByAltText(/discredit button/i).src).toBe(
        'https://img.icons8.com/fluency-systems-filled/20/DD3939/x.png',
      )
    })
  })
})
