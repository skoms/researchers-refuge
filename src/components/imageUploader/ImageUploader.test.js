...
describe('ImageUploader', () => {
  ...
  describe('general (profile)', () => {
    ...
    beforeEach( async () => {
      ...
      await act( async () => {
        store = await renderComponent(ImageUploader, { preloadedState, expectedProps, needsStore, needsMemoryRouter }).store;
      });
    });
    ...
    it('should render without any errors', () => {
      expect(
        screen.getByTestId('image-uploader-component')
      ).toBeInTheDocument();
    });
