...
describe('SearchField', () => {
  describe('not on mobile', () => {
    ...
    it('should render a magnifying glass for the submit button', () => {
      expect(
        screen.getByAltText(/search button/i)
      ).toBeInTheDocument();
    });
    ...
    it('should update the searchTerm state onchange', () => {
      ...
      expect(
        store.getState().searchField.searchTerm
      ).toBe('test text');
    });
    ...
    it('should call the mockHistoryPush with data', () => {
      ...
      expect(
        mockHistoryPush
      ).toHaveBeenCalledWith({ pathname: '/search/test text', state: { from: '/' } });
    });
  })
  ...
  describe('On mobile', () => {
    ...
    it('should render without any errors', () => {
      expect(
        screen.getByAltText(/^toggle search button$/i)
      ).toBeInTheDocument();
    });
